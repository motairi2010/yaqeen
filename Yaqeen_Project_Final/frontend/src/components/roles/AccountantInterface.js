        ...
        {activeTab === 'المالية' && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-blue-50 p-4 rounded-lg text-center">
              <div className="text-2xl font-bold text-blue-600">{financialData.revenue.toLocaleString()} ﷼</div>
        ...
        {activeTab === 'الضريبة' && (
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-blue-600 font-bold">{financialData.taxAmount.toLocaleString()} ﷼</span>
            </div>
        ...
        {activeTab === 'الزكاة' && (
          <div className="bg-green-50 p-6 rounded-lg">
            ...
            <div className="flex justify-between items-center mb-4">
              ...
              <span className="text-green-600 font-bold">{financialData.zakatAmount.toLocaleString()} ﷼</span>
            </div>
