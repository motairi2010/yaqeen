...
export default function Invoices(){
  ...
  return (<div className="invoice-page"className="invoice-page">
    <div className="card"className="card invoice-page">
      <h3 style={{marginTop:0}}>ط·آ·ط¢آ§ط·آ¸أ¢â‚¬â€چط·آ¸ط¸آ¾ط·آ¸ط«â€ ط·آ·ط¢آ§ط·آ·ط¹آ¾ط·آ¸ط¸آ¹ط·آ·ط¢آ±</h3>

      <div className="grid"className="grid invoice-page" style={{gap:12, alignItems:"end"}}>
        <div>
...
function mapPay(k){ return (<div className="invoice-page"className="invoice-page">{cash:"ط·آ¸أ¢â‚¬آ ط·آ¸أ¢â‚¬ع‘ط·آ·ط¢آ¯",card:"ط·آ·ط¢آ¨ط·آ·ط¢آ·ط·آ·ط¢آ§ط·آ¸أ¢â‚¬ع‘ط·آ·ط¢آ©",transfer:"ط·آ·ط¹آ¾ط·آ·ط¢آ­ط·آ¸ط«â€ ط·آ¸ط¸آ¹ط·آ¸أ¢â‚¬â€چ",wallet:"ط·آ¸أ¢â‚¬آ¦ط·آ·ط¢آ­ط·آ¸ط¸آ¾ط·آ·ط¢آ¸ط·آ·ط¢آ©"})[k] || k; }
