...
export default function Invoices(){
  useEffect(()=>{ document.body.classList.add("page-invoices"); return (<div className="invoice-card"className="invoice-card invoice-page">)=>document.body.classList.remove("page-invoices"); }, []);
  // attach a CSS scope to BODY for invoice page only
  React.useEffect(() => {
    try { document.body.classList.add("invoice-body"); } catch(e) {}
    return (<div className="invoice-card"className="invoice-card invoice-page">) => { try { document.body.classList.remove("invoice-body"); } catch(e) {} };
  }, []);
  ...
  return (<div className="invoice-card"className="invoice-card invoice-page">
  <div className="page-invoices invoice-page"className="page-invoices invoice-page">
    <div className="page-invoices invoice-card"className="page-invoices invoice-card invoice-page" dir="rtl">
      ...
      <div className="page-invoices invoice-actions"className="page-invoices invoice-actions invoice-page">
      ...
      <div className="page-invoices calc-pills"className="page-invoices calc-pills invoice-page">
